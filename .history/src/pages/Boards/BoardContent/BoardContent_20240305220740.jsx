    ...
    if (activeColumn._id !== overColumn._id) {
      setOrderedColumns(prevColumns => {
        ...
        if (nextActiveColumn) {
          ...
          nextActiveColumn.cards = nextActiveColumn.cards.filter(card => card._id !==     const activeColumn = findColumnByCardId(activeDraggingCardId)
          )
        ...
        if (nextOverColumn) {
          ...
          nextOverColumn.cards = nextOverColumn.cards.filter(card => card._id !== activeGraggingCardId)

          // Tiếp thao là thêm cái card đang kéo vào overColumn theo vị trí index mới
