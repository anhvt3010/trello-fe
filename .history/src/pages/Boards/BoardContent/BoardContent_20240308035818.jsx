...
import { DndContext, DragOverlay, MouseSensor, TouchSensor, closestCorners, defaultDropAnimationSideEffects, pointerWithin, useSensor, useSensors } from '@dnd-kit/core'
...
function BoardContent({ board }) {
  ...
  const collisionDetectionStrategy = useCallback((args) => {
    ...
    const intersections = !!pointerIntersections?.length ? pointerIntersections :
  }, [activeDragItemType])
