import { AddCard, Cloud, ContentCopy, ContentCut, ContentPaste, DeleteForever, DragHandle, Group } from '@mui/icons-material'
        ...
        <Box sx={{
          ...
          <Card sx={{
            ...
            <CardActions >
              ...
              <Button size="small" startIcon={<Group />}>20</Button><Button size="small" startIcon={<Group />}>20</Button>
            </CardActions>
          </Card>
        </Box>
