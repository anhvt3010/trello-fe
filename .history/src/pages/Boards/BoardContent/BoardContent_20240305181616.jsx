...
import { DndContext, DragOverlay, MouseSensor, PointerSensor, TouchSensor, defaultDropAnimationSideEffects, useSensor, useSensors } from '@dnd-kit/core'
...
function BoardContent({ board }) {
  ...
  // khi thả phần tử kéo thì phần tử giữ chỗ vẫn còn
  const dropAnimation = {
