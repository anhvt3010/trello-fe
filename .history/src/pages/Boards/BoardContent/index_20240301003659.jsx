import { AddCard, Cloud, ContentCopy, ContentCut, ContentPaste, DeleteForever, DragHandle, Group, ModeComment } from '@mui/icons-material'
        ...
        <Box sx={{
          ...
          <Card sx={{
            ...
            <CardActions >
              ...
              <Button size="small" startIcon={<Attach />}>10</Button>
            </CardActions>
          </Card>
        </Box>
